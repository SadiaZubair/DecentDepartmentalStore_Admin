...
export default function Admindetails() {
  ...
  return (
    <form className={classes.root} noValidate autoComplete="off">
      {/* <TextField id="standard-basic" style={{width:'50ch'}} label="Standard" />
      ...
      <button type="button" style={{backgroundColor: '#0277BD', color: '#FFFFFF', width: '150px'}} className={classes.thecolor} class="btn back-color rounded-pill">Update</button>
